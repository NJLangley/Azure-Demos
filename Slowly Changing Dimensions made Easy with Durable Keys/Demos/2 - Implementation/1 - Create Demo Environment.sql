...
/************************************************************************************************************************************************************************
****
****    Create & populate a simple product SCD2 dimension
****
************************************************************************************************************************************************************************/
...
GO
CREATE UNIQUE INDEX IX_dim_Product_#SourceSystem_#SourceId ON dim.Product(SourceSystem, SourceId) WHERE (IsCurrentRow = 1)
GO
...
GO
CREATE UNIQUE INDEX IX_dim_Customer_#SourceSystem_#SourceId ON dim.Customer(SourceSystem, SourceId) WHERE (IsCurrentRow = 1)
GO
...
FROM (
    ...
    ('Website', 1, 'Niall Langley',  'niall.langley@gmail.com',            'Super Customer',     '20200501', '99991231', 1),
